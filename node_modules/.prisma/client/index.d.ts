...
export namespace Prisma {
  ...
  */
  ...
  export type TaskGetPayload<
    ...
    ? Task  & {
    [P in TrueKeys<S['include']>]:
        P extends 'createdBy' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'createdBy' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Task ? Task[P] : never
  } 
    : Task
  : Task
