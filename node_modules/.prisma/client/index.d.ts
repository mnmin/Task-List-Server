...
/**
   ...
   * `prisma.checkList`: Exposes CRUD operations for the **CheckList** model.
    ...
    * ```
    */
  get checkList(): Prisma.CheckListDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    createdTopics?: boolean | TopicFindManyArgs
    createdAt?: boolean
    updatedAt?: boolean
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'createdTasks' ? Array < TaskGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends 'createdTopics' ? Array < TopicGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'createdTasks' ? Array < TaskGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends 'createdTopics' ? Array < TopicGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    createdTasks<T extends TaskFindManyArgs = {}>(args?: Subset<T, TaskFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Task>| Null>, PrismaPromise<Array<TaskGetPayload<T>>| Null>>;

    createdTopics<T extends TopicFindManyArgs = {}>(args?: Subset<T, TopicFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Topic>| Null>, PrismaPromise<Array<TopicGetPayload<T>>| Null>>;
  ...
  export type TaskSelect = {
    ...
    topics?: boolean
    checkLists?: boolean | CheckListFindManyArgs
    createdAt?: boolean
    updatedAt?: boolean
  ...
  export type TaskGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'checkLists' ? Array < CheckListGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
    ...
    [P in TrueKeys<S['select']>]:
        ...
        P extends 'checkLists' ? Array < CheckListGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__TaskClient<T, Null = never> implements PrismaPromise<T> {
    ...
    checkLists<T extends CheckListFindManyArgs = {}>(args?: Subset<T, CheckListFindManyArgs>): CheckSelect<T, PrismaPromise<Array<CheckList>| Null>, PrismaPromise<Array<CheckListGetPayload<T>>| Null>>;
  ...
  export type TopicGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Topic ? Topic[P] : never
  } 
    : Topic
  : Topic
  ...
  export interface TopicDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Topic'> extends True ? CheckSelect<T, Prisma__TopicClient<Topic>, Prisma__TopicClient<TopicGetPayload<T>>> : CheckSelect<T, Prisma__TopicClient<Topic | null, null>, Prisma__TopicClient<TopicGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Topic'> extends True ? CheckSelect<T, Prisma__TopicClient<Topic>, Prisma__TopicClient<TopicGetPayload<T>>> : CheckSelect<T, Prisma__TopicClient<Topic | null, null>, Prisma__TopicClient<TopicGetPayload<T> | null, null>>
  ...
  export type CheckListAggregateArgs = {
    /**
  ...
  export type CheckListGroupByArgs = {
    where?: CheckListWhereInput
  ...
  type GetCheckListGroupByPayload<T extends CheckListGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type CheckListInclude = {
    task?: boolean | TaskArgs
  }

  export type CheckListGetPayload<
    S extends boolean | null | undefined | CheckListArgs,
    U = keyof S
      > = S extends true
        ? CheckList
    : S extends undefined
    ? never
    : S extends CheckListArgs | CheckListFindManyArgs
    ?'include' extends U
    ? CheckList  & {
    [P in TrueKeys<S['include']>]:
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'task' ? TaskGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof CheckList ? CheckList[P] : never
  } 
    : CheckList
  : CheckList


  type CheckListCountArgs = Merge<
    Omit<CheckListFindManyArgs, 'select' | 'include'> & {
      select?: CheckListCountAggregateInputType | true
    }
  >

  export interface CheckListDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends CheckListFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, CheckListFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'CheckList'> extends True ? CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>> : CheckSelect<T, Prisma__CheckListClient<CheckList | null, null>, Prisma__CheckListClient<CheckListGetPayload<T> | null, null>>
     ...
     * })
    **/
    findFirst<T extends CheckListFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, CheckListFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'CheckList'> extends True ? CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>> : CheckSelect<T, Prisma__CheckListClient<CheckList | null, null>, Prisma__CheckListClient<CheckListGetPayload<T> | null, null>>
     ...
     * 
    **/
    findMany<T extends CheckListFindManyArgs>(
      args?: SelectSubset<T, CheckListFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<CheckList>>, PrismaPromise<Array<CheckListGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends CheckListCreateArgs>(
      args: SelectSubset<T, CheckListCreateArgs>
    ): CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends CheckListCreateManyArgs>(
      args?: SelectSubset<T, CheckListCreateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends CheckListDeleteArgs>(
      args: SelectSubset<T, CheckListDeleteArgs>
    ): CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>>
     ...
     * 
    **/
    update<T extends CheckListUpdateArgs>(
      args: SelectSubset<T, CheckListUpdateArgs>
    ): CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends CheckListDeleteManyArgs>(
      args?: SelectSubset<T, CheckListDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends CheckListUpdateManyArgs>(
      args: SelectSubset<T, CheckListUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends CheckListUpsertArgs>(
      args: SelectSubset<T, CheckListUpsertArgs>
    ): CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>>

    /**
     * Find one CheckList that matches the filter or throw
     * `NotFoundError` if no matches were found.
     ...
     * })
    **/
    findUniqueOrThrow<T extends CheckListFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, CheckListFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends CheckListFindFirstOrThrowArgs>(
      args?: SelectSubset<T, CheckListFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__CheckListClient<CheckList>, Prisma__CheckListClient<CheckListGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends CheckListAggregateArgs>(args: Subset<T, CheckListAggregateArgs>): PrismaPromise<GetCheckListAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, CheckListGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCheckListGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__CheckListClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type CheckListFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the CheckList
     * 
    **/
    select?: CheckListSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: CheckListInclude | null
    /**
   ...
   */
  export interface CheckListFindUniqueArgs extends CheckListFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type CheckListFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the CheckList
     * 
    **/
   ...
   * CheckList: findFirst
   */
  export interface CheckListFindFirstArgs extends CheckListFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   * CheckList create
   */
  export type CheckListCreateArgs = {
    /**
     * Select specific fields to fetch from the CheckList
     * 
    **/
   ...
   */
  export type CheckListCreateManyArgs = {
    /**
   ...
   * CheckList update
   */
  export type CheckListUpdateArgs = {
    /**
     * Select specific fields to fetch from the CheckList
     * 
    **/
   ...
   */
  export type CheckListUpdateManyArgs = {
    /**
   ...
   * CheckList upsert
   */
  export type CheckListUpsertArgs = {
    /**
     * Select specific fields to fetch from the CheckList
     * 
    **/
   ...
   * CheckList delete
   */
  export type CheckListDeleteArgs = {
    /**
     * Select specific fields to fetch from the CheckList
     * 
    **/
   ...
   */
  export type CheckListDeleteManyArgs = {
    /**
   ...
   */
  export type CheckListFindUniqueOrThrowArgs = CheckListFindUniqueArgsBase
      

  /**
   * CheckList: findFirstOrThrow
   */
  export type CheckListFindFirstOrThrowArgs = CheckListFindFirstArgsBase
  ...
  export type TaskWhereInput = {
    ...
    id?: IntFilter | number
    taskName?: StringFilter | string
    taskDescription?: StringFilter | string
    linksUrl?: StringNullableFilter | string | null
    status?: EnumStatusFilter | Status
    createdById?: IntFilter | number
    createdBy?: XOR<UserRelationFilter, UserWhereInput>
    topics?: IntNullableListFilter
  ...
  export type TaskScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    taskName?: StringWithAggregatesFilter | string
    taskDescription?: StringWithAggregatesFilter | string
    linksUrl?: StringNullableWithAggregatesFilter | string | null
  ...
  export type UserCreateInput = {
    ...
    createdTopics?: TopicCreateNestedManyWithoutUserInput
  ...
  export type UserUncheckedCreateInput = {
    ...
    createdTopics?: TopicUncheckedCreateNestedManyWithoutUserInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type UserUpdateInput = {
    ...
    createdTopics?: TopicUpdateManyWithoutUserNestedInput
  ...
  export type UserUncheckedUpdateInput = {
    ...
    createdTopics?: TopicUncheckedUpdateManyWithoutUserNestedInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type TaskCreateInput = {
    ...
    topics?: TaskCreatetopicsInput | Enumerable<number>
  ...
  export type TopicCreateInput = {
    topicName: string
    user: UserCreateNestedOneWithoutCreatedTopicsInput
    createdAt?: Date | string
    updatedAt?: Date | string
  }
  ...
  export type TopicUpdateInput = {
    ...
    user?: UserUpdateOneRequiredWithoutCreatedTopicsNestedInput
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
  ...
  export type TaskCreatetopicsInput = {
  ...
  export type TaskUpdatetopicsInput = {
    set?: Enumerable<number>
  ...
  export type TopicUpdateManyWithWhereWithoutUserInput = {
    ...
    data: XOR<TopicUpdateManyMutationInput, TopicUncheckedUpdateManyWithoutCreatedTopicsInput>
  }
  ...
  export type TopicUncheckedUpdateManyWithoutCreatedTopicsInput = {
    id?: IntFieldUpdateOperationsInput | number
    topicName?: StringFieldUpdateOperationsInput | string
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
